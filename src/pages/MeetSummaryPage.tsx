        ...
        <Layout>
            <Container>
                <LeftContentArea>
                    ...
                    <ReportArea>
                        <Text>
                            9월 12일 회의 내용입니다. 인퍼런스용 강의 영상은
                            논문 발표처럼 무겁지 않게, 컨퍼런스 형식의 영상으로
                            진행하면 좋습니다. SK에서 진행한 강의 영상처럼 일반
                            대중을 대상으로 하되, 전문 용어를 적절히 사용하여
                            이해하기 쉬운 방식으로 진행합니다. STTt에서는 청킹을
                            넘어갈 때 불용어 처리가 진행됩니다. MP3 파일을
                            입력하면 NTT 결과와 청킹 결과, 서머리 결과 등이
                            저장되도록 설정되어 있으며, STT 결과물이 청킹과
                            서머리 과정에 자동으로 반영됩니다. 일상 대화도
                            학습만 돌리면 가능하니 제가 시도해보겠습니다. 현재
                            코드가 각 청크별로 블로썸을 거쳐 HTML로 연결되는데,
                            이 과정에서 HTML이 깨지고 시간이 오래 걸립니다. 응답
                            검증이나 퀄리티보다도 인퍼런스 시간을 줄여야 할 것
                            같은데, 최적화 방법이 필요할 듯 합니다. TS에서 했던
                            것처럼 각 청크별로 다음 청크와의 언어적 유사도를
                            비교할 수 있을 것 같습니다. 청킹을 통해 서머리할 때
                            반복되는 문장을 줄이는 방법은 일정 토큰 수를
                            유지하면서 짧은 청크가 생성되지 않도록 하는 것이
                            중요한 것 같습니다. 시간이 부족해도, 영상은 9월
                            말입니다. 이번 달 말까지는 실현 가능성을 봐야 될 것
                            같습니다.
                        </Text>
                    </ReportArea>
                </LeftContentArea>

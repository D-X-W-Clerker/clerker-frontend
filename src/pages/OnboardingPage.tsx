    ...
    <Container>
      ...
      <FeatureSection>
        <Image
          ...
          $height={517}
        />
        <Content $top="45%" $transform="translateX(120%)" $fontSize="48px">
          회의는 간편하게 <br />
          요약은 정확하게
        </Content>
      </FeatureSection>
      <SummarySection>
        ...
        >
          ...
          <strong> 요약 텍스트, 시각적 다이어그램, 요약 영상</strong>으로
          제공하여
          <br />
      ...
      <When2meetSection>
        <ContentWrapper>
          ...
          <Content $top="45%" $transform="translateX(-140%)" $fontSize="52px">
            모두가 가능한 시간 <br />
            손쉽게 찾기
          </Content>
          <Content
      ...
      <ProjectSection>
        ...
        <ContentWrapper>
          ...
          <Content
            ...
            $textAlign="right"
          >
            클러커는 <strong>프로젝트 단위</strong>로 회의를 처리할 수 있는
            강력한 도구입니다.
            <br />
            <br />
            <br />
            프로젝트별로 모든 회의와 일정을 한곳에서 손쉽게 관리하며,
            <br />
            팀의 목표와 계획을 명확하게 유지할 수 있도록 도와줍니다.
            <br />
            복잡한 업무 속에서도 효율적인 협업을 가능하게 하는 클러커와
            함께하세요.
          </Content>
        </ContentWrapper>
      </ProjectSection>
